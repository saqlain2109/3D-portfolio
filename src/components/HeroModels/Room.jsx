...
export function Room({ theme = 'cyberpunk', ...props }) {
  const { nodes, materials } = useGLTF("/models/optimized-room.glb");
  const matcapTexture = useTexture("/images/textures/mat1.png");
  const isCyberpunk = theme === 'cyberpunk';

  const customMaterials = useMemo(() => ({
    curtain: new THREE.MeshPhongMaterial({ color: isCyberpunk ? "#d90429" : "#b5179e" }),
    body: new THREE.MeshPhongMaterial({ map: matcapTexture }),
    table: new THREE.MeshPhongMaterial({ color: isCyberpunk ? "#582f0e" : "#8b4513" }),
    radiator: new THREE.MeshPhongMaterial({ color: isCyberpunk ? "#ffffff" : "#f8fafc" }),
    comp: new THREE.MeshStandardMaterial({ color: isCyberpunk ? "#ffffff" : "#f1f5f9" }),
    pillow: new THREE.MeshPhongMaterial({ color: isCyberpunk ? "#8338ec" : "#f59e0b" }),
    chair: new THREE.MeshPhongMaterial({ color: isCyberpunk ? "#000000" : "#1e293b" }),
    screenGlow: new THREE.MeshStandardMaterial({ 
      color: isCyberpunk ? "#00ffff" : "#fbbf24", 
      emissive: isCyberpunk ? "#00b4d8" : "#d97706", 
      emissiveIntensity: isCyberpunk ? 3.0 : 2.5,
      roughness: 0.1 
    }),
  }), [matcapTexture, isCyberpunk]);
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh
        ...
        material={customMaterials.screenGlow}
      />
      <mesh
