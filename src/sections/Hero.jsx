  ...
  return (
    <section id='hero' className='relative overflow-hidden'>
      ...
      <div className='hero-layout'>
        ...
        {/*RIGHT: 3D Model */}
        <figure className='relative w-full xl:w-1/2 flex flex-col items-center justify-center mt-6 xl:mt-0'>
          {/* Room Lighting Switch Badge - Cleanly positioned above the 3D room canvas */}
          <div className="flex items-center gap-2 bg-black-100/90 border border-cyan-500/30 px-3.5 py-1.5 rounded-full backdrop-blur-md shadow-lg pointer-events-auto mb-3 xl:absolute xl:top-0 xl:right-10 z-30">
